...
class MainActivity : AppCompatActivity() {
    ...
    private val newEmailResultLauncher = registerForActivityResult(
        ...
        if (result.resultCode == RESULT_OK) {
             ...
             * */
            val receiver = result.data!!.getStringExtra(NewEmailActivity.NEW_RECEIVER_KEY)
            val subject = result.data!!.getStringExtra(NewEmailActivity.NEW_SUBJECT_KEY)
            val body = result.data!!.getStringExtra(NewEmailActivity.NEW_BODY_KEY)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewBinding.newBtn.setOnClickListener(View.OnClickListener {
                 ...
                 * */
            val intent = Intent(applicationContext, NewEmailActivity::class.java)
